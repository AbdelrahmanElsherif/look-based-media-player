...
class Window (QWidget):
    ...
    def init_ui(self):
        ...
        faceDetetction.setStyleSheet("color: black; font-size: 16px; background-color: #FF8C00; border-radius: 10px; padding: 10px; text-align: center; ")
        ...
        openBtn.setStyleSheet("color: black; font-size: 12px; background-color: #FF8C00; border-radius: 10px; padding: 10px; text-align: center;")
       ...
       # self.playBtn.setStyleSheet("background-color: yellow ")
        ...
        self.playBtn.setStyleSheet(
            "color: black; font-size: 16px; background-color: #FF8C00; border-radius: 10px; padding: 10px; text-align: center;")
        ...
        while True:
            ...
            if how_many_faces == 0:
             ...
             #   error_dialog.set
                ...
                msg.setWindowIcon(QIcon('sleepy.png'))
                msg.setStyleSheet(
                    'QMessageBox {background-color: #FF8C00; color: white;}\n QMessageBox {color: white;}\n QPushButton{color: white; font-size: 16px; background-color: #1d1d1d; border-radius: 10px; padding: 10px; text-align: center;}\n QPushButton:hover{color: #2b5b84;}')
